...
function SalonRegistrationPart1({ data, updateData, onNext, onBack }) {
  const [personalMessage, setPersonalMessage] = useState("");
  const [businessMessage, setBusinessMessage] = useState("");
  const [step, setStep] = useState(1);

  //Regex patterns for inputs
  const basicRegex = /^[A-Za-z\s]{1,30}$/; //letters with spaces
  ...
  const validatePersonal = () => {
    ...
    if (data.personalEmail !== data.retypePersonalEmail) {
      ...
      console.log("Emails do not match test");
      return false;
    }
              ...
              <div className="formRow">
                ...
                <div className="formGroup">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ personalEmail: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className="formRow">
                ...
                <div className="formGroup">
                  ...
                  <input
                    type="email"
                    placeholder="example@email.com"
                    value={data.retypePersonalEmail || ""}
                    onChange={(e) =>
                      updateData({ retypePersonalEmail: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className="formRow">
                <div className="formGroup">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ yearOfBirth: e.target.value })
                    }
                  />
                </div>
                <div className="formGroup">
              ...
              <div className="formRow">
                <div className="formGroup">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ companyEmail: e.target.value })
                    }
                  />
                </div>
                <div className="formGroup">
                  ...
                  <input
                    type="email"
                    placeholder="business@company.com"
                    value={data.retypeCompanyEmail || ""}
                    onChange={(e) =>
                      updateData({ retypeCompanyEmail: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div className="formRow">
                ...
                <div className="formGroup">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateData({ companyPhone: e.target.value })
                    }
                  />
                </div>
              </div>
          ...
          <>
            ...
            <div className="reviewSection">
              <div className="reviewColumn">
                ...
                <p><strong>Retype Personal Email:</strong> {data.retypePersonalEmail}</p>
              ...
              <div className="reviewColumn">
                ...
                <p><strong>Retype Company Email:</strong> {data.retypeCompanyEmail}</p>
                <p>
