...
export default function MyAppointments() {
    ...
    useEffect(() => {
        if (modalMessage || viewAppointment || cancelAppointment || rescheduleAppointment) {
    ...
    }, [modalMessage, viewAppointment, cancelAppointment, rescheduleAppointment]);
    ...
    const retrieveAllAppointments = async () => {
        try {
            const appt_response = await fetch(`/api/appointments/view?role=customer&id=${user_id}`)
        ...
        <div className="my-appts-page">
            ...
            {/*{rescheduleAppointment && (
                <AppointmentModal 
                    ...
                    reschedule={true}
                    setModalOpen={setRescheduleAppointment}
